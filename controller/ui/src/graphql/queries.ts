/**
 * GraphQL query documents, response types, and a thin fetch helper.
 *
 * Uses plain fetch rather than urql so the dashboard works without a full
 * GraphQL client setup.  Swap gqlFetch for your urql/Apollo client when ready.
 */
